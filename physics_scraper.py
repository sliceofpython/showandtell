...
def get(url):
    ...
    print("----------------------")
    print(soup_get.select(".content-head > h1")[0].text.strip())
    print()
    print(soup_get.select(".content-head > h5")[0].text.strip())
    print()
    print(soup_get.select(".first-block")[0].text.strip())
    for i in range(len(soup_get.select("article > p"))):
        print(soup_get.select("article > p")[i].text.strip())
        print()
